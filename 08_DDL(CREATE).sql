...
CREATE TABLE "MEMBER"(
	...
	MEMBER_SSN CHAR(14), -- '991212-1234567'
...
-- INSERT INTO 테이블명 VALUES(값, 갑2...)
INSERT INTO "MEMBER" VALUES
('MEN01', '123ABC', '홍길동', '991213-1234567', DEFAULT);
...
-- 가입일 -> SYSDATE로 삽입
INSERT INTO "MEMBER" VALUES
('MEN02', 'QWER1234', '김영희', '001213-2233445', SYSDATE);
...
-- * 컬럼 레벨 : 테이블 생성시 컬럼을 정의하는 부분에 작성하는 것
...
VALUES(1, 'USER01', 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong123@kh.co.kr');


INSERT INTO USER_USER_NN
VALUES(NULL, 'USER01', 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong123@kh.co.kr');
...
CREATE TABLE USER_USED_UK(
	...
	USER_ID VARCHAR2(20), -- 회원 아이디 중복검사
	USER_PWD VARCHAR2(20),
	USER_NAME VARCHAR2(30),
	GENDER VARCHAR2(10),
	PHONE VARCHAR2(30),
...
VALUES(1, 'USER01', 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');
-- SQL Error [1] [23000]: 
-- ORA-00001: 무결성 제약 조건(KH_NCW.USER_ID_U)에 위배됩니다
...
INSERT INTO USER_USED_UK2
VALUES(1, 'USER01', 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');
-- SQL Error [1] [23000]: ORA-00001: 무결성 제약 조건(KH_NCW.USER_ID_NAME_U)에 위배됩니다
...
-- 기본키 중복 오류!
-- SQL Error [1] [23000]: ORA-00001: 무결성 제약 조건(KH_NCW.USER_NO_PK)에 위배됩니다



INSERT INTO USER_USED_PK
VALUES(NULL, 'USER03', 'PASS03', '유관순', '여자', '010-1212-1211', 'yoo123@kh.or.kr');
-- 기본키에 NULL 이므로 오류!
-- SQL Error [1400] [23000]: ORA-01400: 
-- NULL을 ("KH_NCW"."USER_USED_PK"."USER_NO") 안에 삽입할 수 없습니다


INSERT INTO USER_USED_PK
VALUES(2, 'USER03', 'PASS03', '유관순', '여자', '010-1212-1211', 'yoo123@kh.or.kr');
...
INSERT INTO USER_USED_PK2
VALUES(1, 'USER01', 'PASS02', '이순신', '남자', '010-1234-5678', 'lee123@kh.or.kr');
-- SQL Error [1] [23000]: ORA-00001: 무결성 제약 조건(KH_NCW.PK_USERNO_USERID)에 위배됩니다
-- USER_NO, USER_ID 둘 다 중복되었을 때만 제약조건 위배 에러 발생!


INSERT INTO USER_USED_PK2
VALUES(NULL, 'USER03', 'PASS01', '홍길동', '남자', '010-1234-5678', 'lee123@kh.or.kr');
-- SQL Error [1400] [23000]: ORA-01400: NULL을 ("KH_NCW"."USER_USED_PK2"."USER_NO") 안에 삽입할 수 없습니다
...
-- 부모 테이블 / 참조 테이블/ 레퍼런스 테이블 (대상이 되는 테이블)
...
CREATE TABLE USER_USED_FK(
	...
	-- 테이블 레벨
	-- , CONSTRAINT GRADE_CODE FK FORIEGN KEY(GRADE_CODE) REFERENCES USER_GRADE
...
INSERT INTO USER_USED_FK
VALUES(2, 'USER02', 'PASS02', '이순신', '남자', '010-5678-5678', 'lee1233@kh.or.kr', 10);
...
INSERT INTO USER_USED_FK
VALUES(5, 'USER05', 'PASS05', '윤봉길', '여자', '010-5555-6666', 'yoo123@kh.or.kr', 50);
-- SQL Error [2291] [23000]: 
-- ORA-02291: 무결성 제약조건(KH_NCW.GRADE_CODE_FK)이 위배되었습니다- 부모 키가 없습니다
...
-- SQL Error [2292] [23000]: ORA-02292: 무결성 제약조건(KH_NCW.GRADE_CODE_FK)이 위배되었습니다- 자식 레코드가 발견되었습니다
...
SELECT * FROM USER_GRADE2; -- 10 삭제
SELECT * FROM USER_USED_FK2; -- 10을 사용하고 있던 자식 레코드 값이 NULL이 됨을 확인
...
SELECT * FROM USER_USED_FK3; -- 부모의 10을 참조하고 있던 자식 행 삭제됨
...
VALUES(1, 'USER01', 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');
-- SQL Error [2290] [23000]: ORA-02290: 체크 제약조건(KH_NCW.GENDER_CHECK)이 위배되었습니다
